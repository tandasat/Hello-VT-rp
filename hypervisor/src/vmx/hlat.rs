...
pub(crate) fn protect_la(vm: &mut Vm) {
    ...
    vm.hlat.pml4.0.entries[i4].set_accessed(false);
    vm.hlat.pml4.0.entries[i4].set_dirty(false);
    ...
    vm.hlat.pdpt.0.entries[i3].set_accessed(false);
    vm.hlat.pdpt.0.entries[i3].set_dirty(false);
    ...
    vm.hlat.pd.0.entries[i2].set_accessed(false);
    vm.hlat.pd.0.entries[i2].set_dirty(false);
    ...
    //vm.hlat.pt.0.entries[i1].set_accessed(false);
    //vm.hlat.pt.0.entries[i1].set_dirty(false);
    //vm.hlat.pt.0.entries[i1].set_restart(false);

    vm.hlat.pt.0.entries[i1].0 = 0;
    vm.hlat.pt.0.entries[i1].set_pfn(pte.pfn());
    vm.hlat.pt.0.entries[i1].set_present(true);

    assert!(!vm.hlat.pml4.0.entries[i4].restart());
    assert!(!vm.hlat.pdpt.0.entries[i3].restart());
    assert!(!vm.hlat.pd.0.entries[i2].restart());
    assert!(!vm.hlat.pt.0.entries[i1].restart());
